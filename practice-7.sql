...
select listings.property_type, count(*),max(date_reviewed) from reviews inner join listings on listings.id = reviews.listing_id group by listings.property_type;
